...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
	<form name="WPTS" action="#">
		...
		<table border="0" cellpadding="4" cellspacing="0">
         <tr>
            <td nowrap="nowrap"><label for="tabname">Enter Youtube Link</label></td>
            <td><input type="text" id="tabname" name="tabname" value="" size="50" /></td>
          </tr>
		  <tr>
			<td></td>
            <td nowrap="nowrap"><label for="ex">e.g. https://www.youtube.com/watch?v=dW22dChgpRE</label></td>
		...
		<div style="float: none; text-align: center; margin-top: 25px;">
