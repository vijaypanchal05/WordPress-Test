...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper">
        <input id="field-st-address" type="text" name="ss" value="<?php echo $location_name; ?>" class="form-control <?php echo esc_attr($is_required); ?>" placeholder="<?php if($placeholder) echo $placeholder; ?>">
        <!--<select  name="ss" class="st-location-id st-hidden" placeholder="<?php //if($placeholder) echo $placeholder; ?>" tabindex="-1">
            <option value=""></option>
            <?php 
