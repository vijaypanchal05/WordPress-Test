...
if(!empty($data)):
	?>
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left form-group-transfer">
	<label for="field-car-dropoff"><?php echo $title; ?></label>
	<select class="selectpicker transfer-selectpicker <?php echo esc_attr($is_required) ?>" name="transfer_from" data-live-search="true">
