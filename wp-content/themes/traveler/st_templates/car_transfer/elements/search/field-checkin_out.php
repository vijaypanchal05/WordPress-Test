...
<div class="row">
	<div class="col-xs-12 col-sm-6">
		<label for="field-transfer-checkin"><?php echo __('Arrival Date Time', ST_TEXTDOMAIN); ?></label>
		<div class="row">
			<div class="col-xs-7">
	...
	<div class="col-xs-12 col-sm-6 form-group-transfer-end">
		<label for="field-transfer-checkout"><?php echo __('Departure Date Time', ST_TEXTDOMAIN); ?></label>
		<div class="row">
			<div class="col-xs-7">
				<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange form-group-icon-left">
				    <i class="fa fa-calendar input-icon input-icon-highlight"></i>
