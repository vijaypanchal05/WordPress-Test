...
if(isset($item_id) and $item_id):
    ...
    <ul class="booking-item-payment-details">
        <li>
            <p class="booking-item-payment-item-title"><?php echo esc_html( $item['data']['pick_up'] ) . ' - ' . esc_html($item['data']['pick_up']); ?></p>
            <ul class="booking-item-payment-price">
                <li>
                    ...
                    <p class="booking-item-payment-price-amount">
                        <?php echo date_i18n(TravelHelper::getDateFormat() . ' H:i:s', strtotime($check_in_time)); ?>
                    </p>
                </li>
                <?php if(!empty($check_out_time)): ?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount">
                            <?php echo date_i18n(TravelHelper::getDateFormat() . ' H:i:s', strtotime($check_out_time)); ?>
                        </p>
                    </li>
                <?php endif; ?>  
                <?php if($passenger) {?>
