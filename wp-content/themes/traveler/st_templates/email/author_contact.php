...
<table id="" class="wrapper" style="padding-top: 70px; width: 800px; color: #666;" width="90%" cellspacing="0"
    ...
    <tr>
        <td style="padding: 20px 0; font-size: 20px;">Hello <strong
                style="font-size: 25px;"><?php echo $data[0]['value']; ?></strong>,
        </td>
    </tr>
    <tr>
        <td>You have a message from <strong style="color: #ed8323;"><?php echo $data[1]['value']; ?></strong>. Please check info below:
        </td>
    </tr>
    <tr>
        ...
        <td style="padding-top: 30px;">
            <table style="width: 100%; border-collapse: collapse; color: #666;" border="1">
                ...
                <tr>
                    ...
                    <td style="padding: 20px 30px; color: #ed8323;"><?php echo $data[1]['value']; ?></td>
                </tr>
                <tr>
                    <td style="padding: 20px 30px;">Email:</td>
                    <td style="padding: 20px 30px;"><?php echo $data[2]['value']; ?></td>
                </tr>
                <tr>
                    <td style="padding: 20px 30px;">Content:</td>
                    <td style="padding: 20px 30px;"><?php echo $data[3]['value']; ?></td>
                </tr>
                </tbody>
            </table>
        </td>
