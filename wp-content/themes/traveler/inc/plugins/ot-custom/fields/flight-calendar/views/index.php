...
<div class="row calendar-wrapper" data-post-id="<?php echo $post->ID; ?>">
    <div class="col-xs-12 col-lg-4">
        <div class="calendar-form">
            ...
            <div class="form-group">
                <label for="calendar_price"><strong><?php echo __('Economy Price ($)', ST_TEXTDOMAIN); ?></strong></label>
            ...
            <div class="form-group">
                <label for="calendar_price"><strong><?php echo __('Business Price ($)', ST_TEXTDOMAIN); ?></strong></label>
