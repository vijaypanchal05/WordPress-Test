        ...
        class STTour extends TravelerObject
        {
            ...
            public function st_filter_tour_ajax()
            {
                ...
                if ($query->have_posts()) {
                    ...
                    echo '<h3 class="ajax-filter-not-found">'. __('No tour found', ST_TEXTDOMAIN) .'</h3>';
                }
            ...
            {
                if ( $check = STInput::get( 'orderby', 'name_a_z' ) ) {
                    global $wpdb;
                    switch ( $check ) {
                        case "price_asc":
            ...
            */
            function do_add_to_cart()
            {
                ...
                if ( $max_number > 0 ) {
                    ...
                    $result      = TourHelper::_get_free_peple_by_time( $item_id, strtotime( $check_in ), strtotime( $check_out ), $starttime );
