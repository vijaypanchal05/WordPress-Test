                ...
                if($st_style=='1') {
                    if ($query->have_posts()) {
                        ...
                        while ($query->have_posts()) {
                            $query->the_post();
                            echo st()->load_template('rental/loop','list',array());
                        }
                        echo "</ul>";
                    }
                    ...
                    <div class="row row-wrap st_fix_clear style_box">
                        ...
                        while($query->have_posts()){
                            $query->the_post();
                            echo st()->load_template('rental/loop','grid',array());
                        }
                        ?>
                    </div>
                    <?php
                ...
                */
                ...
                if ( $rental_external_booking == "on" && $rental_external_booking_link !== "" ) {
                    if ( get_post_meta( $post_id, 'st_rental_external_booking_link', true ) ) {
                        ob_start();
                        ?>
                        <a class='btn btn-primary' data-toggle="tooltip" data-placement="top" title="<?php echo __('External booking', ST_TEXTDOMAIN); ?>"
