...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_filter_price_ajax' )) {
    class WPBakeryShortCode_st_filter_price_ajax extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            $data = shortcode_atts( array(
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_filter_rate_ajax' )) {
    class WPBakeryShortCode_st_filter_rate_ajax extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            $data = shortcode_atts( array(
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_filter_hotel_rate_ajax' )) {
    class WPBakeryShortCode_st_filter_hotel_rate_ajax extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            $data = shortcode_atts( array(
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_filter_taxonomy_ajax' )) {
    class WPBakeryShortCode_st_filter_taxonomy_ajax extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            $data = shortcode_atts( array(
