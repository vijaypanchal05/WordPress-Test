    ...
    class TravelHelper
    {
        ...
        static public function st_author_contact()
        {
            ...
            if ($check) {
                $res = [
                    'status' => true,
                    'message' => __("End email successfully!", ST_TEXTDOMAIN)
                ];
            } else {
                $res = [
                    'status' => false,
        ...
        static function buildTreeOptionLocation($locations, $location_id)
        {
            if (is_array($locations) && count($locations)):
                foreach ($locations as $key => $value):
                    ...
                    ?>
                    <option data-style="padding-left: <?php echo $level . 'px;'; ?>" <?php selected($value['ID'], $location_id); ?> data-country="<?php echo $value['Country']; ?>"
